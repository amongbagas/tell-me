...
export async function GET() {
    try {
        ...
        const wsUrl = (process.env.NEXT_PUBLIC_WEBSOCKET_URL as string) || "ws://localhost:8080";
        ...
        return NextResponse.json(
            {
                success: false,
                error: errorMessage,
                serverUrl: (process.env.NEXT_PUBLIC_WEBSOCKET_URL as string) || "ws://localhost:8080",
            },
            { status: 500 }
        );
    }

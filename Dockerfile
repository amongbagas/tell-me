...
ARG NEXT_PUBLIC_TURN_URLS_ARG
ARG NEXT_PUBLIC_TURN_USERNAME_ARG
ARG NEXT_PUBLIC_TURN_CREDENTIAL_ARG

ENV NEXT_PUBLIC_WEBSOCKET_URL=${NEXT_PUBLIC_WEBSOCKET_URL_ARG}
ENV NEXT_PUBLIC_TURN_URLS=${NEXT_PUBLIC_TURN_URLS_ARG}
ENV NEXT_PUBLIC_TURN_USERNAME=${NEXT_PUBLIC_TURN_USERNAME_ARG}
ENV NEXT_PUBLIC_TURN_CREDENTIAL=${NEXT_PUBLIC_TURN_CREDENTIAL_ARG}
